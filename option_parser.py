...
def get_parser():
    ...
    parser.add_argument("--latent_feature", type = int, default = 64)
    ...
    parser.add_argument('--model', type=str, default='deep', help = 'cycle, deep')
    ...
    parser.add_argument('--dis_linear', type=bool, default=True)
    return parser
